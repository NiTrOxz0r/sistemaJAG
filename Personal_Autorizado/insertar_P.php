...
if (isset($_POST['cedula'])) {
	...
	$_SESSION['cedula_r'] =	mysqli_escape_string($con, $_POST['cedula']);
  ...
  cod_usr_mod
	...
	VALUES('$_SESSION[cedula_r]','$nacionalidad','$p_nombre','$s_nombre','$p_apellido',
	'$s_apellido','$sexo','$fec_nac','$telefono','$telefono_otro','$status',
	'$cod_usr_reg','$cod_usr_mod');";

	$res = conexion($queryP);
  
  $query = "SELECT codigo from persona where cedula = '$_SESSION[cedula_r]';";
  ...
  cod_usr_mod
	...
	header("Location:../alumno/form_reg_A.php");

}else{
		echo "POr favor Registrarse";
}
