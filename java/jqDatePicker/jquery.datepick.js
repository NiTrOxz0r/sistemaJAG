	...
	alert('Now in ' + month + '/' + year);
 	...
 	alert('Selected ' + dates);
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US -- Cambiando a Español
				...
				prevText: '&lt;Ant',
				prevStatus: 'Muestra el mes Anterior',
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'Muestra el Año Anterior',
				nextText: 'Sig&gt;',
				nextStatus: 'Muestra el Siguiente Mes',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'Muestra el Siguiente Año',
				currentText: 'Actual',
				currentStatus: 'Muestra el mes actual',
				todayText: 'Hoy',
				...
				yearStatus: 'Cambia el año',
				monthStatus: 'Cambia el mes',
				weekText: 'Wk',
				weekStatus: 'Semana del año',
				dayStatus: 'Select DD, M d, yyyy',
				defaultStatus: 'Elija una fecha',
				isRTL: false
			}
		},
