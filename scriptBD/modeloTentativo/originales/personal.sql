CREATE TABLE personal (
  ...
  certificado_1 tinyint(3) unsigned default 1,
  descripcion_1 varchar(80) default "-",
  certificado_2 tinyint(3) unsigned default 1,
  descripcion_2 varchar(80) default "-",
  certificado_3 tinyint(3) unsigned default 1,
  descripcion_3 varchar(80) default "-",
  certificado_4 tinyint(3) unsigned default 1,
  descripcion_4 varchar(80) default "-",
