...
function encuentraCedula($cedula_x = 0){
  ...
  if ( $cedula_x and preg_match( "/[0-9]{8}/", $cedula_x) ) :
    ...
    if ($resultado->num_rows <> 0):
      $consultar_P = enlaceDinamico("github/sistemaJAG/Personal_Autorizado/consultar_P.php?tipo=1&informacion=$cedula");
    ...
    $resultado = conexion($query);
    if ($resultado->num_rows <> 0):
      $consultar_A = enlaceDinamico("github/sistemaJAG/alumno/consultar_A.php?tipo=1&informacion=$cedula");
      mysqli_close($conexion);
      return $consultar_A;
    endif;
    $query = "SELECT persona.cedula
    ...
    $resultado = conexion($query);
    if ($resultado->num_rows <> 0):
      $consultar_A = enlaceDinamico("github/sistemaJAG/alumno/consultar_U.php?tipo=1&informacion=$cedula");
      return $consultar_A;
    endif;
